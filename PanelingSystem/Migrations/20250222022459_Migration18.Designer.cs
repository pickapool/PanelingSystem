...
namespace PanelingSystem.Migrations
{
    ...
    [Migration("20250222022459_Migration18")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PanelingSystem.Models.DefenseVerdictModel", b =>
                {
                    b.Property<long>("DefenseVerdictId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("DefenseVerdictId"));
                    ...
                    b.HasKey("DefenseVerdictId");

                    b.ToTable("DefenseVerdicts", (string)null);
                });
            ...
            modelBuilder.Entity("PanelingSystem.Models.MembersModel", b =>
                {
                    ...
                    b.Property<double>("PreOralGrade")
                        .HasColumnType("float");

                    b.Property<double>("TitleGrade")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PanelingSystem.Models.PanelGradeModel", b =>
                {
                    b.Property<int>("PanelGradeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PanelGradeId"));
                    ...
                    b.HasKey("PanelGradeId");

                    b.HasIndex("UserAccountUserId");

                    b.ToTable("PanelGrades", (string)null);
                });
            ...
            modelBuilder.Entity("PanelingSystem.Models.PanelGradeModel", b =>
                {
                    b.HasOne("PanelingSystem.Models.UserAccountModel", "UserAccount")
                        .WithMany()
